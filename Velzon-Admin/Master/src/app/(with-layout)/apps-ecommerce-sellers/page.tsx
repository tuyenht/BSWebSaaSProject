...
import SellerChats from "@components/EcommerceProducts/SellerChats";
...
const EcommerceSellers = () => {
  ...
  document.title =
    "Sellers | Velzon - Next.js TypeScript Admin & Dashboard Template";
  return (
    <React.Fragment>
                ...
                <Col xl={3} lg={6}>
                  <Card className="ribbon-box right overflow-hidden">
                    <CardBody className="text-center p-4">
                      ...
                      <Image src={seller.img} alt="" height={45} width={45} />
