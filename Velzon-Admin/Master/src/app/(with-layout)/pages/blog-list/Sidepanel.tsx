...
const small4 = "/images/small/img-4.jpg";
const small6 = "/images/small/img-6.jpg";
const small7 = "/images/small/img-7.jpg";
          ...
          <CardBody className="p-4">
            ...
            <div className="mt-4 pt-4 border-top border-dashed border-bottom-0 border-start-0 border-end-0">
              ...
              <ul className="list-unstyled fw-medium">
                <li>
                  <Link href="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right me-1"></i> Art & Design
                  </Link>
                </li>
                <li>
                  <Link href="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right me-1"></i> Inspiration &
                    Innovation{" "}
                ...
                <li>
                  <Link href="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right me-1"></i> Lifestyle
                  </Link>
                </li>
                <li>
                  <Link href="#" className="text-muted py-2 d-block">
            ...
            <div className="mt-4 pt-4 border-top border-dashed border-bottom-0 border-start-0 border-end-0">
              ...
              <ul className="list-unstyled fw-medium">
                <li>
                  <Link href="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right me-1"></i> 2024{" "}
                    <span className="badge badge-soft-success rounded-pill float-end ms-1 font-size-12">
                      03
                    </span>
                  </Link>
                ...
                <li>
                  <Link href="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right me-1"></i> 2021{" "}
                    <span className="badge badge-soft-success rounded-pill float-end ms-1 font-size-12">
                      05
                    </span>
                  </Link>
            ...
            <div className="mt-4 pt-4 border-top border-dashed border-bottom-0 border-start-0 border-end-0">
              ...
              <div className="list-group list-group-flush">
                <Link href="#" className="list-group-item text-muted py-3 px-2">
                ...
                <Link href="#" className="list-group-item text-muted py-3 px-2">
                  <div className="d-flex align-items-center">
                    <div className="flex-shrink-0 me-3">
                      <Image
                        src={small6}
                        alt="Project discussion with team"
                        width={64}
                        height={64}
                        className="avatar-md h-auto d-block rounded"
                      />
            ...
            <div className="mt-4 pt-4 border-top border-dashed border-bottom-0 border-start-0 border-end-0">
              ...
              <div className="d-flex flex-wrap gap-2 widget-tag">
                <div>
                  <Link
                    href="#"
                    className="badge bg-light text-muted font-size-12"
                  >
                    Design
                  </Link>
                </div>
