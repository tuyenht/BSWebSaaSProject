...
const Ratio169Example = () => (
  <PrismCode code={ratio169Code} language={"js"} plugins={["line-numbers"]} />
);
...
const Ratio219Example = () => (
  <PrismCode code={ratio219Code} language={"js"} plugins={["line-numbers"]} />
);
...
const Ratio43Example = () => (
  <PrismCode code={ratio43Code} language={"js"} plugins={["line-numbers"]} />
);
...
const Ratio11Example = () => (
  <PrismCode code={ratio11Code} language={"js"} plugins={["line-numbers"]} />
);
