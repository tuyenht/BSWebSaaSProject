...
const UiTabs = () => {
  ...
  const headerJustifyToggle = (tab: string) => {
  ...
  const arrowNavToggle = (tab: string) => {
    if (arrowNavTab !== tab) {
      setarrowNavTab(tab);
    }
  };
  ...
  const bottonCardToggle = (tab: string) => {
  ...
  const customtoggleVertical = (tab: string) => {
  ...
  const animationNavToggle = (tab: string) => {
  ...
  const navBadgeToggle = (tab: string) => {
    if (navBadgeTab !== tab) {
      setnavBadgeTab(tab);
    }
  };
  ...
  const topBordertoggle = (tab: string) => {
    if (topBorderTab !== tab) {
      settopBorderTab(tab);
    }
  };
  ...
  const topBorderJustifytoggle = (tab: string) => {
  ...
  const colorNavToggle = (tab: string) => {
    if (colorNavTab !== tab) {
      setcolorNavTab(tab);
    }
  };
  ...
  const outlineBorderNavtoggle = (tab: string) => {
  ...
  const customNavtoggle = (tab: string) => {
    if (customNav !== tab) {
      setcustomNav(tab);
    }
  };
  ...
  document.title =
    "Tabs | Velzon - Next.js TypeScript Admin & Dashboard Template";
                  ...
                  <TabContent activeTab={activeTab} className="text-muted">
                    <TabPane tabId="1" id="home">
                      ...
                      <p className="mb-0">
                        ...
                        or graphic. That&apos;s why it&apos;s important to think
                        about your message, then choose a font that fits. Cosby
                    ...
                    <TabPane tabId="2" id="product">
                      ...
                      <p className="mb-0">
                        ...
                        font styles that are different but complementary, like
                        sans serif with serif, short with tall, or decorative
                        with simple. Qui photo booth letterpress, commodo enim
                      ...
                      >
                        ...
                        <TabPane tabId="2" id="v-pills-profile">
                          ...
                          <p className="mb-0">
                            ...
                            complementary. You can always play around with the
                          ...
                          <div className="d-flex mb-2">
                            ...
                            <div className="flex-grow-1 ms-3">
                              <p className="mb-0">
                                ...
                                the software you&apos;re working with reputable
                                font websites.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="d-flex mb-2">
                            ...
                            <div className="flex-grow-1 ms-3">
                              <p className="mb-0">
                                ...
                                what you&apos;re trying to say. You can make a
                                big statement by using little tricks, like this
                                one. Use contrasting fonts. you can use a bold
                                sanserif font with a cursive.
                              </p>
                            </div>
                          </div>
                          <p className="mb-0">
                            If you&apos;re using multiple elements, make sure
                            that your principal object is larger than the
                            others, as the eye of your viewer will automatically
                            be drawn to the larger of the two objects.
                          </p>
                        </TabPane>
                      </TabContent>
                    </Col>
                  ...
                  <TabContent activeTab={arrowNavTab} className="text-muted">
                    ...
                    <TabPane tabId="2" id="arrow-profile">
                      ...
                      <p className="mb-0">
                        ...
                        that&apos;s why using contrasting colors in{" "}
                        <Link href="#" className="text-decoration-underline">
                          <b>Graphic Design</b>
                        </Link>{" "}
                        is a must. It&apos;s eye-catching, it makes a statement,
                        it&apos;s impressive graphic design. Increase or
                        decrease the letter spacing depending on the situation
                        and try, try again until it looks right, and each letter
                        has the perfect spot of its own.
                      </p>
                    </TabPane>
                    <TabPane tabId="3" id="arrow-contact">
                      ...
                      <p className="mb-0">
                        ...
                        people&apos;s interest is that it has become more and
                  ...
                  <TabContent activeTab={bottomCardTab} className="text-muted">
                    <TabPane tabId="1" id="bottomtabs-home">
                      ...
                      <p className="mb-2">
                        ...
                        If you&apos;re not trying to create crazy contrast in
                        your design, then a great idea would be for you to use a
                    ...
                    <TabPane tabId="3" id="bottomtabs-messages">
                      ...
                      <p className="mb-2">
                        ...
                        &quot;, Alex Trebek&apos;s fun TV quiz game. Woven silk
                          ...
                          <div className="d-flex mb-4">
                            ...
                            <div className="flex-grow-1 ms-3">
                              <p className="mb-0">
                                ...
                                you already have in the software you&apos;re
                                working with reputable font websites. commodo
                                enim craft beer mlkshk aliquip jean shorts
                                ullamco ad vinyl cillum PBR. Homo nostrud
                          ...
                          <div className="d-flex">
                            <div className="flex-grow-1 me-3">
                              <p className="mb-0">
                                ...
                                in the software you&apos;re working with
                                reputable font websites.
                              </p>
                            </div>
                            <div className="flex-shrink-0">
                          ...
                          <div className="d-flex">
                            <div className="flex-grow-1 me-3">
                              <p className="mb-0">
                                ...
                                neutral, exotic or graphic. That&apos;s why
                                it&apos;s important to think about your message,
                                then choose a font that fits. Cosby sweater eu
                    ...
                    <TabPane tabId="1" id="nav-light-home">
                      <div className="d-flex mb-1">
                        <div className="flex-grow-1 me-3">
                          ...
                          magna delectus. pposites attract, and that&apos;s a
                          fact. It&apos;s in our nature to be interested in the
                    ...
                    <TabPane tabId="2" id="nav-light-profile">
                      <div className="d-flex mb-1">
                        <div className="flex-grow-1 me-3">
                          ...
                          on top of an image, it&apos;s important that your
                          viewers can understand the text, and sometimes that
                          means applying a gaussian readable Any bypasser will
                          stop to see what you have to see, even if your design
                      ...
                      <p className="mb-0">
                        ...
                        depending on the situation and try, try again until it
                        looks right, and each letter has the perfect spot of its
                        own. commodo enim craft beer mlkshk aliquip jean shorts
                        ullamco.
                      </p>
                    </TabPane>
                    ...
                    <TabPane tabId="3" id="nav-colored-messages">
                      <div className="d-flex mb-1">
                        <div className="flex-grow-1 me-3">
                          ...
                          you&apos;re not trying to create crazy contrast in
                          your design.
                        </div>
                        <div className="flex-shrink-0">
                          <Image
