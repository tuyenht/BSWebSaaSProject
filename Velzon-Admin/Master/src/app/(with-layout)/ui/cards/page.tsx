...
// Logos
const spinner1 = "/images/logo-sm.png";
            ...
            <Col sm={6} xl={3}>
              <Card>
                ...
                <div className="card-footer">
                  <Link href="#" className="card-link link-secondary">
                    Read More{" "}
                    <i className="ri-arrow-right-s-line ms-1 align-middle lh-1"></i>
                  </Link>
                  <Link href="#" className="card-link link-success">
                    Bookmark{" "}
              ...
              <Row>
                <Col lg={6} xxl={4}>
                  <Card>
                    ...
                    <div className="card-footer">
                      <Link href="#" className="link-success float-end">
                        Read More{" "}
                  ...
                  <Card>
                    ...
                    <CardBody>
                      ...
                      <p className="card-text text-muted mb-0">
                        ...
                        meta-services itself or distract the viewer&apos;s
              ...
              <Card>
                ...
                <div className="card-footer">
                  <div className="hstack gap-2 justify-content-end">
                    <Link href="#" className="btn btn-link btn-sm link-success">
              ...
              <Card>
                ...
                <div className="card-footer text-center">
                  <ul className="list-inline mb-0">
                    ...
                    <li className="list-inline-item">
                      <Link href="#" className="lh-1 align-middle link-success">
                        <i className="ri-whatsapp-line"></i>
                      </Link>
                    </li>
                    <li className="list-inline-item">
                      <Link href="#" className="lh-1 align-middle link-primary">
                        <i className="ri-linkedin-fill"></i>
                      </Link>
                    </li>
                    <li className="list-inline-item">
                      <Link href="#" className="lh-1 align-middle link-danger">
                ...
                <Col xxl={4}>
                  <Card className="border card-border-success">
                    ...
                    <CardBody>
                      ...
                      <div className="text-end">
                        <Link href="#" className="link-success fw-medium">
                          Read More{" "}
                          <i className="ri-arrow-right-line align-middle"></i>
                        </Link>
                      </div>
                ...
                <Col xxl={4}>
                  <Card className="border card-border-info">
                    ...
                    <CardBody>
                      ...
                      <div className="text-end">
                        <Link href="#" className="link-info fw-medium">
                          Read More{" "}
                          <i className="ri-arrow-right-line align-middle"></i>
                        </Link>
                      </div>
            ...
            <Col xxl={4}>
              <Card className="border card-border-warning">
                ...
                <CardBody>
                  ...
                  <div className="text-end">
                    <Link href="#" className="link-warning fw-medium">
                      Read More{" "}
                      <i className="ri-arrow-right-line align-middle"></i>
                    </Link>
                  </div>
            ...
            <Col xxl={4}>
              <Card className="border card-border-danger">
                ...
                <CardBody>
                  ...
                  <div className="text-end">
                    <Link href="#" className="link-danger fw-medium">
                      Read More{" "}
                      <i className="ri-arrow-right-line align-middle"></i>
                    </Link>
                  </div>
                      ...
                      <Row className="g-0 bg-light position-relative">
                        ...
                        <Col md={7} className="p-4">
                          ...
                          <p>
                            ...
                            some real-world content would look like, and
                            we&apos;re using it here to give the component a bit
                            of body and size.
                          </p>
                          <Link href="#" className="stretched-link">
                            Go somewhere
