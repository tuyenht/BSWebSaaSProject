...
const UiList = () => {
  document.title =
    "List | Velzon - Next.js TypeScript Admin & Dashboard Template";
  return (
    <React.Fragment>
      <UiContent />
          ...
          <Row>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>tag=&quot;a&quot;</code> to create actionable list
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>tag=&quot;button&quot;</code> to create actionable
          ...
          <Row>
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>color=&quot;Required color&quot;</code> to style
                    list items with a stateful background and color.
                  </p>
                  <div className="live-preview">
                    <ListGroup>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>tag=&quot;a&quot; to=&quot;#&quot;</code> to add
                    link. Note the addition of the hover styles here not present
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <Link href="https://getbootstrap.com/docs/5.1/utilities/flex/">
                      flexbox utilities
                    </Link>
                    .
                  </p>
                    ...
                    <ListGroup>
                      ...
                      >
                        ...
                        <p className="list-text mb-0">
                          ...
                          exotic or graphic. That&apos;s why it&apos;s important
                          to think about your message, then choose a font that
                          fits. Cosby sweater eu banh mi, qui irure terry
                          richardson ex squid.
                        </p>
                      </ListGroupItem>
                      <ListGroupItem
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <Link href="https://getbootstrap.com/docs/5.1/utilities/">
                      utilities
                    </Link>
                    .
                  </p>
