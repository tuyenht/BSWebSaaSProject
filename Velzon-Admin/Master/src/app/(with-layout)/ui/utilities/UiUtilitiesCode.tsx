...
<div className="vstack gap-3">
    <div className="bg-light border material-shadow p-1 px-2">First item</div>
    <div className="bg-light border material-shadow p-1 px-2">Second item</div>
    <div className="bg-light border material-shadow p-1 px-2">Third item</div>
</div>

<div className="vstack gap-2">
    <Button color="primary" className="material-shadow">Save changes</Button>
    <Button color="secondary" className="material-shadow-none" outline>Cancel</Button>
</div>
`;
...
<div className="hstack gap-3">
    <div className="bg-light material-shadow border p-1 px-2">First item</div>
    <div className="bg-light material-shadow border p-1 px-2">Second item</div>
    <div className="bg-light material-shadow border p-1 px-2">Third item</div>
</div>

<div className="hstack gap-3">
    <div className="bg-light material-shadow border p-1 px-2">First item</div>
    <div className="bg-light material-shadow border p-1 px-2 ms-auto">Second item</div>
    <div className="bg-light material-shadow border p-1 px-2">Third item</div>
</div>
...
<div className="hstack gap-3">
    ...
    <div className="bg-light border material-shadow p-1 px-2 ms-auto">Third item</div>
</div>
...
<div className="hstack gap-3"> 
    ...
    <div className="vr"></div>
    <Button color="secondary" classNAme="material-shadow-none" outline>Reset</Button>
</div>
`;
