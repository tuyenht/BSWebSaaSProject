...
const UiButtons = () => {
  document.title =
    "Buttons | Velzon - Next.js TypeScript Admin & Dashboard Template";

  const favouriteBtn = (ele: Element) => {
    const button = ele.closest("button");
                      ...
                      <Col lg={6}>
                        <div className="d-flex flex-wrap align-items-center gap-2">
                          <Button
                            ...
                            onClick={e => favouriteBtn(e.target as Element)}
                          >
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>data-bs-toggle=&quot;button&quot;</code> to toggle
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <Link href="/ui-colors">theme colors</Link>. Note that the
