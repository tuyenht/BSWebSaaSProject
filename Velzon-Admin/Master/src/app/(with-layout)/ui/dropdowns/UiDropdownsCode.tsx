...
<ButtonGroup className='material-shadow'>
    <UncontrolledDropdown>
        <DropdownToggle tag="button" className="btn btn-primary material-shadow-none btn-lg">
...
<ButtonGroup className='material-shadow'>
    <UncontrolledButtonDropdown>
        ...
        <DropdownToggle tag="button" className="btn btn-light material-shadow-none btn-lg" split>
        </DropdownToggle>
        <DropdownMenu >
            <DropdownItem>Action</DropdownItem>
            <DropdownItem>Another action</DropdownItem>
...
<ButtonGroup className='material-shadow'>
    <UncontrolledDropdown>
        <DropdownToggle tag="button" className="btn btn-primary material-shadow-none btn-sm">
...
<ButtonGroup className='material-shadow'>
    <UncontrolledButtonDropdown>
        ...
        <DropdownToggle tag="button" className="btn btn-light material-shadow-none btn-sm" split>
        </DropdownToggle>
        <DropdownMenu >
            <DropdownItem>Action</DropdownItem>
            <DropdownItem>Another action</DropdownItem>
        ...
        <div className="p-3">
            <Row className="align-items-center">
                ...
                <div className="col-auto dropdown-tabs">
                    <span className="badge bg-light fs-13"> 4 New</span>
                </div>
            </Row>
        </div>
