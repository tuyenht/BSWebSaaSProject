...
// SVGs
const bell = "/images/svg/bell.svg";
...
const UiDropdowns = () => {
  ...
  const toggleNotification = (tab: string) => {
  ...
  const toggleNotification1 = (tab: string) => {
  ...
  document.title =
    "Dropdowns | Velzon - Next.js TypeScript Admin & Dashboard Template";
