...
<!-- Rounded Ribbon -->
<Card className="ribbon-box border shadow-none mb-lg-0 material-shadow">
    <CardBody>
...
<!-- Right Ribbon -->
<Card className="ribbon-box border shadow-none right mb-lg-0 material-shadow">
    <CardBody>
...
<Card className="ribbon-box border shadow-none mb-lg-0 right material-shadow">
    <CardBody>
...
<!-- Filled Ribbons -->
<Card className="ribbon-box border ribbon-fill shadow-none mb-lg-0 material-shadow">
    <CardBody>
...
<!-- Right Ribbon -->
<Card className="ribbon-box border ribbon-fill shadow-none right mb-lg-0 material-shadow">
    <CardBody>
...
const RibbonsExample = () => (
  <PrismCode code={ribbonsCode} language={"js"} plugins={["line-numbers"]} />
);
...
<!-- Ribbons Hover -->
<Card className="ribbon-box border shadow-none overflow-hidden material-shadow">
    <CardBody className="text-muted">
...
<Card className="ribbon-box right border shadow-none overflow-hidden material-shadow">
    <CardBody className="text-muted">
        <div className="ribbon ribbon-info ribbon-shape trending-ribbon">
