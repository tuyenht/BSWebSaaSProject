...
const UiAccordions = () => {
  ...
  const toggleWithIcons = (id: string) => {
    if (openWithIcons !== id) {
      setOpenWithIcons(id);
    }
  };
  ...
  const toggleWithoutIcons = (id: string) => {
  ...
  const togglePlusIcon = (id: string) => {
    if (openPlusIcon !== id) {
      setOpenPlusIcon(id);
    }
  };
  ...
  const toggleNesting1 = (id: string) => {
    if (openNesting1 !== id) {
      setOpenNesting1(id);
    }
  };
  ...
  const toggleNesting2 = (id: string) => {
    if (openNesting2 !== id) {
      setOpenNesting2(id);
    }
  };
  ...
  const toggleNesting21 = (id: string) => {
    if (openNesting21 !== id) {
      setOpenNesting21(id);
    }
  };
  ...
  const toggleFillColored = (id: string) => {
  ...
  const toggleFillColored1 = (id: string) => {
  ...
  document.title =
    "Accordions | Velzon - Next.js TypeScript Admin & Dashboard Template";
                    ...
                    >
                      ...
                      <AccordionItem className="material-shadow">
                        ...
                        <AccordionBody accordionId="3">
                          ...
                          extra for growth. Don&apos;t worry, there are no
                          ...
                          >
                                ...
                                >
                                  <AccordionItem className="material-shadow">
                                    ...
                                    <AccordionBody accordionId="1">
                                      ...
                                      text they are met with will be a
                                      &quot;welcome back&quot; message instead
                                      of the auto reply.
                                    </AccordionBody>
                                  </AccordionItem>
                                </Accordion>
                            ...
                            <AccordionItem className="material-shadow">
                              ...
                              <AccordionBody accordionId="2">
                                ...
                                &quot;welcome back&quot; message instead of the
                                auto reply.
                              </AccordionBody>
                            </AccordionItem>
                          </Accordion>
                        ...
                        >
                          <AccordionItem className="material-shadow">
                            ...
                            <AccordionBody accordionId="1">
                              ...
                              account. Simply provide us with a url where
                              you&apos;d like the data to be sent, choose which
                              events you&apos;d like to be informed of, and
                              click save.
                            </AccordionBody>
                          </AccordionItem>
                          <AccordionItem className="material-shadow">
                            ...
                            <AccordionBody accordionId="2">
                              ...
                              be the number after &quot;word=&quot;. Too much or
