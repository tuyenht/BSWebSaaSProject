...
const UiProgress = () => {
  document.title =
    "Progress | Velzon - Next.js TypeScript Admin & Dashboard Template";
  return (
    <React.Fragment>
      <UiContent />
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>color=&quot;Required Color&quot;</code> attribute
                    to progress bar class with the below-mentioned color
                    variation to set the background color progress bar.
                  </p>
