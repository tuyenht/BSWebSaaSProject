...
// Import Images
const loginImg = "/images/modals/login.png";
const signupImg = "/images/modals/signup.png";
const subscribeImg = "/images/modals/subscribe.png";
const paymentImg = "/images/modals/success-payment.png";
const authbg = "/images/auth-one-bg.jpg";
...
const UiModals = () => {
  ...
  document.title =
    "Modals | Velzon - Next.js TypeScript Admin & Dashboard Template";
      ...
      >
        ...
        <ModalBody>
          ...
          <p className="text-muted">
            ...
            you do every day. So let&apos;s get started. First, some common
            types of fonts and what you need to know about them triggers a
            popover on click.
          </p>
        ...
        <div className="modal-footer">
          <div className="mx-auto">
            <Link href="#" className="btn btn-link fw-medium">
              Read More{" "}
      ...
      >
        ...
        <div className="modal-footer bg-light p-3 justify-content-center">
          <p className="mb-0 text-muted">
            ...
            <Link href="#" className="link-secondary fw-semibold">
              Invite Friends
            </Link>
          </p>
        </div>
