...
const UiScrollbar = () => {
  document.title =
    "Scrollbar | Velzon - Next.js TypeScript Admin & Dashboard Template";
  return (
    <React.Fragment>
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>data-simplebar-direction=&quot;rtl&quot;</code>{" "}
                    attribute and add <code>max-height: **px</code> to set
                    simplebar at right side.
                  </p>
              ...
              <Row>
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use{" "}
                        <code>data-simplebar-track=&quot;primary&quot;</code>{" "}
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use{" "}
                        <code>data-simplebar-track=&quot;secondary&quot;</code>{" "}
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use{" "}
                        <code>data-simplebar-track=&quot;success&quot;</code>{" "}
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track=&quot;info&quot;</code>{" "}
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use{" "}
                        <code>data-simplebar-track=&quot;warning&quot;</code>{" "}
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track=&quot;danger&quot;</code>{" "}
                        attribute to set danger color simplebar track.
                      </p>
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track=&quot;dark&quot;</code>{" "}
