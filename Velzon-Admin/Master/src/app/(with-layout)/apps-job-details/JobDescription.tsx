      ...
      <Card>
        <CardBody>
          ...
          <ul className="list-inline mb-0">
            ...
            <li className="list-inline-item">
              <Link href="#" className="btn btn-icon btn-soft-info">
                <i className="ri-facebook-line"></i>
              </Link>
            </li>
            <li className="list-inline-item">
              <Link href="#" className="btn btn-icon btn-soft-success">
                <i className="ri-whatsapp-line"></i>
              </Link>
            </li>
            <li className="list-inline-item">
              <Link href="#" className="btn btn-icon btn-soft-secondary">
                <i className="ri-twitter-line"></i>
              </Link>
            </li>
            <li className="list-inline-item">
              <Link href="#" className="btn btn-icon btn-soft-danger">
