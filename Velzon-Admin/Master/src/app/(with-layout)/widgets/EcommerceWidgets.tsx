...
const img4 = "/images/products/img-4.png";
const img5 = "/images/products/img-5.png";
const img6 = "/images/products/img-6.png";
const img8 = "/images/products/img-8.png";
...
const EcommerceWidgets = () => {
  ...
  const confirmPayment = (): void => {
    const selectedRadio = document?.querySelector<HTMLInputElement>(
      "input[name=listGroupRadioGrid]:checked"
    );
    ...
    if (selectedRadio) {
      ...
      const successPayElement = document.querySelector(
        "#notification-overlay .success-pay"
      );
  ...
  const backToHome = (): void => {
    const notificationOverlay: HTMLElement | null = document.getElementById(
      "notification-overlay"
    );
                  ...
                  <div>
                    <div className="bg-success-subtle rounded">
                      <Image
                        ...
                        src={img4}
                        alt=""
                        style={{ maxHeight: "210px", maxWidth: "auto" }}
                      />
                    </div>
                    <div className="pt-3">
                      <h5 className="text-secondary">$99.94</h5>
            ...
            <CardBody>
              <div className="d-flex align-items-center mb-3">
                ...
                <div className="flex-grow-1">
                  ...
                  <h5 className="fs-15 fw-bold mb-0">
                    Half Sleeve T-Shirts (Blue)
                  </h5>
                </div>
              </div>
              <p className="text-muted pb-1">
                If you couldn&apos;t relate to the information in the previous
                point, you might be looking for the singlet T-shirt, which is
                also known as the half T-shirt.
              </p>
                ...
                <Col xl={6}>
                  ...
                  <ul className="clothes-size list-unstyled hstack gap-2 mb-0">
                    <li>
                      ...
                      <label
                        className="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center material-shadow-none rounded-circle"
                        htmlFor="color-1"
                      >
                        S
                      </label>
                  ...
                  <div>
                    ...
                    <div className="d-flex flex-wrap gap-2 select-color">
                      ...
                      >
                        <button
                          type="button"
                          className="btn avatar-xs p-0 material-shadow-none d-flex align-items-center justify-content-center border rounded-circle fs-22 text-primary"
                          disabled
                        >
                      ...
                      >
                        <button
                          type="button"
                          className="btn avatar-xs p-0 material-shadow-none d-flex align-items-center justify-content-center border rounded-circle fs-22 text-secondary"
                        >
                          <i className="ri-checkbox-blank-circle-fill"></i>
                        </button>
                      </div>
                      ...
                      >
                        <button
                          type="button"
                          className="btn avatar-xs p-0 material-shadow-none d-flex align-items-center justify-content-center border rounded-circle fs-22 text-success"
                        >
                          <i className="ri-checkbox-blank-circle-fill"></i>
                        </button>
                      </div>
                      ...
                      >
                        <button
                          type="button"
                          className="btn avatar-xs p-0 material-shadow-none d-flex align-items-center justify-content-center border rounded-circle fs-22 text-info"
                        >
                          <i className="ri-checkbox-blank-circle-fill"></i>
                        </button>
                      </div>
              ...
              <div className="d-flex mb-4 align-items-center">
                <div className="flex-grow-1">
                  <h5 className="text-primary fs-18 mb-0">
                    <span>$22.45</span>{" "}
                    <small className="text-decoration-line-through text-muted fs-13">
                      $37.45
                    </small>
                  </h5>
                </div>
              ...
              <Link href="#" className="btn btn-soft-danger d-block">
                Add to Cart
              </Link>
            </CardBody>
          </Card>
          ...
          <Card>
            <CardBody className="position-relative">
              ...
              <div
                ...
                className="position-absolute top-0 start-0 end-0 d-none"
              >
                ...
                <div className="text-center">
                  ...
                  <div className="mt-4 pt-2">
                    ...
                    <div>
                      <button
                        type="button"
                        className="btn btn-danger btn-sm w-sm"
                        id="back-btn"
                        onClick={backToHome}
                      >
                        Back to Home
                  ...
                  <div>
                    ...
                    <div className="d-flex flex-wrap gap-2 select-color">
                      ...
                      >
                        <button
                          type="button"
                          className="btn avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-22 text-primary"
                          disabled
                        >
                          <i className="ri-checkbox-blank-circle-fill"></i>
                        </button>
                      ...
                      >
                        <button
                          type="button"
                          className="btn avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-22 text-secondary"
                        >
                          <i className="ri-checkbox-blank-circle-fill"></i>
                        </button>
                      </div>
                      ...
                      >
                        <button
                          type="button"
                          className="btn avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-22 text-success"
                        >
                          <i className="ri-checkbox-blank-circle-fill"></i>
                        </button>
                      </div>
                      ...
                      >
                        <button
                          type="button"
                          className="btn avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-22 text-info"
                        >
                          <i className="ri-checkbox-blank-circle-fill"></i>
                        </button>
                      </div>
                    ...
                    <ul className="list-unstyled mb-0 pt-2" id="candidate-list">
                        ...
                        >
                          ...
                          <div className="flex-grow-1">
                            <h5 className="fs-13 mb-1 text-truncate">
                              <span className="candidate-name">Anna Adame</span>{" "}
                      ...
                      <li>
                        ...
                        >
                          ...
                          <div className="flex-grow-1">
                            <h5 className="fs-13 mb-1 text-truncate">
                              <span className="candidate-name">Jason Tran</span>{" "}
                              <span className="text-muted fw-normal">
                                @Jason
                              </span>
                            </h5>
              ...
              <div className="col-lg-6">
                <div className="card-body text-center">
                  ...
                  <div>
                    ...
                    >
                      <i className="ri-add-fill me-1 align-bottom"></i> Follow
                    </button>
                  </div>
                </div>
              </div>
