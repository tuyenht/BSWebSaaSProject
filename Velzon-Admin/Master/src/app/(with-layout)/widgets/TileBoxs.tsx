              ...
              <CardBody>
                ...
                <div className="d-flex align-items-end justify-content-between mt-4">
                  ...
                  <div className="avatar-sm flex-shrink-0">
                    <span
                      className={
                        "avatar-title rounded material-shadow fs-3 bg-" +
                        item.iconClass
                      }
                    >
                ...
                <div className="d-flex justify-content-between">
                  <div>
                    ...
                    >
                      {item.subCounter.map((subItem, subKey) => (
                        <span className="counter-value" key={subKey}>
                          <CountUp
                            start={0}
                  ...
                  <div>
                    <div className="avatar-sm flex-shrink-0">
                      <span
                        className={
                          "avatar-title rounded-circle material-shadow fs-2 bg-" +
                          item.iconClass
                        }
                      >
                        <FeatherIcon
