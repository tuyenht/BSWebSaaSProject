...
const product2 = "/images/products/img-2.png";
const product8 = "/images/products/img-8.png";
const product10 = "/images/products/img-10.png";
            ...
            <CardBody className="pt-0">
              ...
              <Row className="align-items-center mt-2 text-center text-sm-start">
                ...
                <Col className="col-sm-auto">
                  <Pagination
                    size="sm"
                    className="pagination-separated pagination-sm justify-content-center justify-content-sm-start mb-0"
                  >
                    <PaginationItem>
                      {" "}
                    ...
                    <UncontrolledDropdown className="card-header-dropdown">
                      ...
                      >
                        <span className="text-muted">
                          <i className="ri-settings-4-line align-middle me-1 fs-15"></i>
                          Settings
                        </span>
                      </DropdownToggle>
                      <DropdownMenu className="dropdown-menu-end">
                  ...
                  <SimpleBar style={{ maxHeight: "364px" }} className="p-3">
                    <div className="acitivity-timeline acitivity-main">
                      ...
                      <div className="acitivity-item py-3 d-flex">
                        <div className="flex-shrink-0 avatar-xs acitivity-avatar">
                          <div className="avatar-title bg-primary-subtle text-primary rounded-circle material-shadow">
