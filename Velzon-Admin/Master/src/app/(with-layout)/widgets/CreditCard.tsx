          ...
          <Card className="card-height-100">
            ...
            <CardBody>
              ...
              <form id="custom-card-form" autoComplete="off">
                <div className="mb-3">
                  <label htmlFor="card-num-input" className="form-label">
                    Card Number
                  </label>
                  <input
                    id="card-num-input"
                ...
                <div className="mb-3">
                  <label htmlFor="card-holder-input" className="form-label">
                    Card Holder
                  </label>
                  <input
                    type="text"
                ...
                <Row>
                  ...
                  <div className="col-lg-4">
                    <div>
                      <label htmlFor="expiry-year-input" className="form-label">
                        Expiry Year
                      </label>
                  ...
                  <div className="col-lg-4">
                    <div className="cvc">
                      <label htmlFor="cvc-input" className="form-label">
                        CVC
                      </label>
                      <input
                        type="text"
