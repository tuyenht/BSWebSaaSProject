            ...
            <CardHeader className="align-items-center d-flex">
              ...
              <div className="flex-shrink-0">
                <Button
                  color="primary"
                  size="sm"
                  className="btn-soft-primary material-shadow"
                >
                  Export Report
                </Button>
              </div>
            ...
            <CardHeader className="align-items-center d-flex">
              ...
              <div>
                <Button
                  color="secondary"
                  size="sm"
                  className="material-shadow-none btn-soft-secondary me-1"
                >
                  ALL
                </Button>
                <Button
                  color="primary"
                  size="sm"
                  className="material-shadow-none btn-soft-primary me-1"
                >
                  1M
                </Button>
                <Button
            ...
            <CardHeader className="border-0 align-items-center d-flex">
              ...
              <div>
                ...
                <Button
                  color="primary"
                  size="sm"
                  className="material-shadow-none btn-soft-primary"
                >
                  1Y
                </Button>
              </div>
                    ...
                    <div className="d-flex">
                      ...
                      <div className="flex-grow-1 ms-2">
                        ...
                        <p className="fs-12 mb-0 text-muted">
                          <i
                            className={`mdi mdi-circle fs-10 align-middle me-1 text-${item.coinNameClass}`}
                          ></i>
                          {item.coinName}
                        </p>
                      </div>
