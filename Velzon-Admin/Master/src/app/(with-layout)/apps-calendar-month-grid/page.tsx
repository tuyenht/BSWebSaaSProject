...
const MonthGridCalender = () => {
  ...
  useEffect(() => {
    if (startDateRef.current?._input) {
      startDateRef.current._input.id = "event-start-date";
      startDateRef.current._input.name = "defaultDate";
    }
    if (startTimeRef.current?._input) {
      startTimeRef.current._input.name = "start";
    }
    if (endTimeRef.current?._input) {
      endTimeRef.current._input.name = "end";
    }
  }, []);
