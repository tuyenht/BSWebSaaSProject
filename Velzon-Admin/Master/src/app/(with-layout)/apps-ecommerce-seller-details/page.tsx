...
import {
  ...
  Published,
  Price,
} from "@components/EcommerceProducts/EcommerceProductCol";
...
const EcommerceSellerDetail = () => {
          ...
          <>
            <div className="d-flex align-items-center">
              <div className="flex-shrink-0 me-3">
                <div className="avatar-sm bg-light rounded p-1 position-relative">
                  <Image
  ...
  document.title =
    "Sellers Details | Velzon - Next.js TypeScript Admin & Dashboard Template";
