...
const CheckBoxAndRadio = () => {
  document.title =
    "Checkbox & Radio | Velzon - Next.js TypeScript Admin & Dashboard Template";
  return (
    <React.Fragment>
      <UiContent />
                      ...
                      <Col lg={4} md={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>type=&quot;checkbox&quot;</code> attribute
                            to set a checkbox and add{" "}
                    ...
                    <Row>
                      <Col lg={4} md={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>type=&quot;radio&quot;</code> attribute to
                            set a radio button and add{" "}
                            <code>defaultChecked</code> attribute to set a radio
                            checked by default.
                          </p>
                          <div className="form-check mb-2">
                            <Input
