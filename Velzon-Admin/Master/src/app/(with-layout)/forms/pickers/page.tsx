...
const FormPickers = () => {
  ...
  const onSwatchHover_RGBA = (color: ColorResult) => {
    const format =
      "rgba(" +
      color.rgb.r +
      "," +
  ...
  const onSwatchHover_Cust = (color: ColorResult) => {
    const format1 =
      "rgba(" +
      color.rgb.r +
      "," +
  ...
  document.title =
    "Pickers | Velzon - Next.js TypeScript Admin & Dashboard Template";
