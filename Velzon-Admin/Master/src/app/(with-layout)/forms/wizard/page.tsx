...
//Import images
// User
const dummyUser = "/images/users/user-dummy-img.jpg";
...
const FormWizard = () => {
  ...
  document.title =
    "Wizard | Velzon - Next.js TypeScript Admin & Dashboard Template";
  return (
    <React.Fragment>
