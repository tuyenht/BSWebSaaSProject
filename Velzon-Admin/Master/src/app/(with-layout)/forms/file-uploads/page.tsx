...
// Import React FilePond and add type references
...
// Type for FilePond files
type FilePondFileType = unknown;

const FileUpload = () => {
  const [selectedFiles, setselectedFiles] = useState<FileWithPreview[]>([]);
  const [files, setFiles] = useState<FilePondFileType[]>([]);

  function handleAcceptedFiles(files: FileWithPreview[]) {
    files.map(file =>
      Object.assign(file, {
  ...
  document.title =
    "File Upload | Velzon - Next.js TypeScript Admin & Dashboard Template";
  return (
    <React.Fragment>
