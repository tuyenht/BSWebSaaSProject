...
// Define interface for group options
...
const GroupOptions2: SelectOption[] = [
...
const noSortingGroup: SelectOption[] = [
...
const FormSelect = () => {
  ...
  const [selectedGroup2, setSelectedGroup2] = useState<SelectOption | null>(
    null
  );
  const [selectedNoSortingGroup, setSelectedNoSortingGroup] =
    useState<SelectOption | null>(null);
  const [selectedMulti, setselectedMulti] = useState<SelectOption[]>([]);
  const [selectedMulti2, setselectedMulti2] = useState<SelectOption[]>([]);
  const [selectedMulti3, setselectedMulti3] = useState<SelectOption[]>([]);

  function handleSelectSingle(selectedOption: SelectOption | null) {
    setSelectedSingle(selectedOption);
  }

  function handleSelectGroups(selectedOption: SelectOption | null) {
    setSelectedGroup(selectedOption);
  }

  function handleSelectGroups2(selectedOption: SelectOption | null) {
    setSelectedGroup2(selectedOption);
  }

  function handleSelectNoSortingGroup(selectedOption: SelectOption | null) {
    setSelectedNoSortingGroup(selectedOption);
  }

  function handleMulti(selectedOptions: readonly SelectOption[]) {
    setselectedMulti(selectedOptions as SelectOption[]);
  }

  function handleMulti2(selectedOptions: readonly SelectOption[]) {
    setselectedMulti2(selectedOptions as SelectOption[]);
  }

  function handleMulti3(selectedOptions: readonly SelectOption[]) {
    setselectedMulti3(selectedOptions as SelectOption[]);
  }

  document.title =
    "Form Select | Velzon - Next.js TypeScript Admin & Dashboard Template";
                        ...
                        <Col lg={4} md={6}>
                          <div className="mb-3">
                            ...
                            <Select
                              ...
                              onChange={handleSelectNoSortingGroup}
                        ...
                        <Col lg={4} md={6}>
                          <div className="mb-3">
                            ...
                            <p className="text-muted">
                              Set{" "}
                              <code>
                                data-choices data-choices-limit=&quot;Required
                                Limit&quot;{" "}
                              </code>{" "}
                              attribute.
                            </p>
