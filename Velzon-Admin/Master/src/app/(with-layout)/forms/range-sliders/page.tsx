...
const FormRangeSlider = () => {
  ...
  const pipsOptions = {
    ...
    density: 4,
    format: {
      to: (value: number) => parseInt(value.toString()),
      from: (value: number) => parseInt(value.toString()),
    },
  };

  document.title =
    "Range Slider | Velzon - Next.js TypeScript Admin & Dashboard Template";
                    ...
                    <div>
                      ...
                      <div className="mt-4">
                        ...
                        <p className="text-muted">
                          ...
                          values. To change this, you can specify a step value.
                          In the example below, we double the number of steps by
                          using <code>step=&quot;0.5&quot;</code> attribute.
                        </p>
