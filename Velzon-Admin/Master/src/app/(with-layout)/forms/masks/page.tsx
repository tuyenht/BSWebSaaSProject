...
// Define interface for Cleave.js event
...
const Masks = () => {
  ...
  //Date
  function onDateChange(e: CleaveEvent) {
    setDate(e.target.rawValue);
  }
  //Date Format
  function onDateFormatChange(e: CleaveEvent) {
    setDateFormat(e.target.rawValue);
  }
  //Time
  function onTimeChange(e: CleaveEvent) {
    setTime(e.target.rawValue);
  }
  //Time Format
  function onTimeFormatChange(e: CleaveEvent) {
    setTimeFormat(e.target.rawValue);
  }
  //Credit card
  function onCreditCardChange(e: CleaveEvent) {
    setCreditCardNo(e.target.rawValue);
  }

  //Delimeter
  function onDelimiterChange(e: CleaveEvent) {
    setDelimiter(e.target.rawValue);
  }
  //Delimeter
  function onDelimiterChange2(e: CleaveEvent) {
    setDelimiter2(e.target.rawValue);
  }

  //Prefix
  function onPrefixChange(e: CleaveEvent) {
    setPrefix(e.target.rawValue);
  }
  //Phone
  function onPhoneChange(e: CleaveEvent) {
    setPhone(e.target.rawValue);
  }
  //Number
  function onNumberChange(e: CleaveEvent) {
    setNumber(e.target.rawValue);
  }

  document.title =
    "Input Masks | Velzon - Next.js TypeScript Admin & Dashboard Template";
                        ...
                        <Col xl={6}>
                          <div className="mb-3">
                            ...
                            <Cleave
                              ...
                              value={date}
                              onChange={(e: CleaveEvent) => onDateChange(e)}
                        ...
                        <Col xl={6}>
                          <div className="mb-3">
                            ...
                            <Cleave
                              ...
                              value={time}
                              onChange={(e: CleaveEvent) => onTimeChange(e)}
                              className="form-control"
                            />
                          </div>
                        </Col>
                        ...
                        <Col xl={6}>
                          <div className="mb-3">
                            ...
                            <Cleave
                              ...
                              value={prefix}
                              onChange={(e: CleaveEvent) => onPrefixChange(e)}
                              className="form-control"
                            />
                          </div>
                        </Col>
                        ...
                        <Col xl={6}>
                          <div className="mb-3 mb-xl-0">
                            ...
                            <Cleave
                              ...
                              value={phone}
                              onChange={(e: CleaveEvent) => onPhoneChange(e)}
                              className="form-control"
                            />
                          </div>
                        </Col>
                        ...
                        <Col xl={6}>
                          <div className="mb-0">
                            ...
                            <Cleave
                              ...
                              value={number}
                              onChange={(e: CleaveEvent) => onNumberChange(e)}
                              className="form-control"
                            />
                          </div>
                        </Col>
