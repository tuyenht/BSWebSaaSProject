...
const BasicElements = () => {
  document.title =
    "Basic Elements | Velzon - Next.js TypeScript Admin & Dashboard Template";
                      ...
                      <Col lg={4}>
                        <div>
                          ...
                          <p className="text-muted">
                            ...
                            <code>type=&quot;file&quot;</code> tag for default
                            file input.
                          </p>
                          <Input
                            className="form-control"
                      ...
                      <Col lg={4}>
                        <div>
                          ...
                          <p className="text-muted">
                            ...
                            <code>type=&quot;file&quot;</code> attribute within
                            the input attribute to set a default size file
                            input.
                          </p>
                          <Input
                            className="form-control"
