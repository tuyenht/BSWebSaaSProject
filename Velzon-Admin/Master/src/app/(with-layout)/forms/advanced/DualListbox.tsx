...
const DualListbox = () => {
  ...
  const [selectedOptGroup, setSelectedOptGroup] = useState<string[]>([
    "hyundai",
    "skoda",
    "tata",
    "toyota",
  ]);
  const [selectedFilter, setSelectedFilter] = useState<string[]>(["luna"]);
          ...
          <div className="mt-4 mt-lg-0">
            ...
            <DualListBox
              ...
              filterCallback={(option, filterInput) => {
                ...
                // Check if option has a label directly or is a group with a label
              ...
              onChange={(e: string[]) => setSelectedOptGroup(e)}
              icons={{
                moveLeft: <span className="mdi mdi-chevron-left" key="key" />,
                moveAllLeft: [
                  <span className="mdi mdi-chevron-double-left" key="key" />,
        ...
        <Col lg={6}>
          <div className="mt-4">
            ...
            <DualListBox
              ...
              onChange={(e: string[]) => setSelectedFilter(e)}
              icons={{
                moveLeft: <span className="mdi mdi-chevron-left" key="key" />,
                moveAllLeft: [
                  <span className="mdi mdi-chevron-double-left" key="key" />,
