...
// Define CountryType for better type safety
interface CountryType {
  id: number;
  flagImg: string | StaticImageData;
  countryName: string;
  countryCode: string;
}
...
const FormAdvanced = () => {
  ...
  document.title =
    "Form Advanced | Velzon - Next.js TypeScript Admin & Dashboard Template";

  const [seletedCountry, setseletedCountry] = useState("");
  const [seletedCountry1, setseletedCountry1] = useState<CountryType>(
    {} as CountryType
  );

  const [seletedCountry2, setseletedCountry2] = useState("");
  const [seletedCountry3, setseletedCountry3] = useState<CountryType>({
    id: 240,
    flagImg: usflag,
  ...
  const [seletedCountry4, setseletedCountry4] = useState<CountryType>({
    id: 240,
    flagImg: usflag,
    countryName: "United States of America",
    countryCode: "+1",
                        ...
                        <Dropdown isOpen={dropdownOpen} toggle={toggle}>
                          ...
                          >
                            <SimpleBar
                              ...
                              className="px-3"
                            >
                              {country.map((item: CountryType, key: number) => (
                                <DropdownItem
                                  as="li"
                                  onClick={() =>
