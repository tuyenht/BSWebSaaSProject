...
// Define field names type for type safety
type FieldName = keyof ValidationState;
...
const ReactValidation = () => {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const fnm = (
      document.getElementById("validationTooltip01") as HTMLInputElement
    )?.value;
    const lnm = (
      document.getElementById("validationTooltip02") as HTMLInputElement
    )?.value;
    const unm = (
      document.getElementById("validationTooltipUsername") as HTMLInputElement
    )?.value;
    const city = (
      document.getElementById("validationTooltip03") as HTMLInputElement
    )?.value;
    const stateV = (
      document.getElementById("validationTooltip04") as HTMLInputElement
    )?.value;
  ...
  const onChangeValidation = (fieldName: FieldName, value: string) => {
    const modifiedV: ValidationState = { ...validation };
    if (value !== "") {
