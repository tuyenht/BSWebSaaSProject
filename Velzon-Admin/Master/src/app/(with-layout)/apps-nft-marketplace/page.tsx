...
const BgPattern = "/images/nft/bg-pattern.png";
      ...
      <div className="page-content">
        <Container fluid>
              ...
              >
                <CardBody className="p-4">
                  ...
                  <div className="hstack gap-2">
                    <Link href="/apps-nft-create" className="btn btn-success">
                      Create NFT
                    </Link>
          ...
          <Row className="row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
            {tradingArtworkData.map((item: any, key: number) => (
              <Col key={key}>
          ...
          <Row className="row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
            {nftArtworkData.map((item: any, key: number) => (
              <Col key={key}>
          ...
          <Row className="row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
            {popularCreatorsNFT.map((item: any, key: number) => (
              <Col key={key}>
                <Card>
                  <Image
                    src={item.cardImg}
