        ...
        <Container fluid className="container-fluid">
          ...
          <Row>
            <Col lg={12}>
              <div className="text-center mb-3">
                <button
                  className="btn btn-link text-info mt-2 material-shadow-none"
                  id="loadmore"
                >
          ...
          >
            ...
            <ModalBody>
              ...
              >
                <div className="mb-4">
                  <label htmlFor="icon-input" className="form-label">
                    Icon{" "}
                  ...
                  {validation.touched.iconName && validation.errors.iconName ? (
                    <FormFeedback type="invalid">
                      {validation.errors.iconName}
                    </FormFeedback>
                  ) : null}
                </div>

                <div className="mb-4">
                  <label htmlFor="lable-input" className="form-lable">
                    Category
                  </label>
                  <Input
                    type="text"
