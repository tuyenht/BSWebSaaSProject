      ...
      <div className="col-xxl-3">
        <div className="card card-height-100">
              ...
              <UncontrolledDropdown>
                ...
                <DropdownMenu className="dropdown-menu dropdown-menu-end">
                  <DropdownItem
                    ...
                    className={seletedMonth === "Btc" ? "active" : ""}
                  >
                    BTC
                  </DropdownItem>
                  <DropdownItem
                    ...
                    className={seletedMonth === "usd" ? "active" : ""}
                  >
                    USD
                  </DropdownItem>
                  <DropdownItem
                    ...
                    className={seletedMonth === "euro" ? "active" : ""}
                  >
                    Euro
                  </DropdownItem>
                </DropdownMenu>
          ...
          <div className="card-body">
            <PortfolioCharts
              series={chartData}
              chartId="portfolio_donut_charts"
            />
            ...
            <ul className="list-group list-group-flush border-dashed mb-0 mt-3 pt-2">
                ...
                <div className="d-flex">
                  <div className="flex-shrink-0 avatar-xs">
                    <span className="avatar-title bg-light p-1 rounded-circle material-shadow">
                      <Image src={btc} alt="BTC" width={32} height={32} />
                    </span>
                  </div>
              ...
              <li className="list-group-item px-0">
                <div className="d-flex">
                  <div className="flex-shrink-0 avatar-xs">
                    <span className="avatar-title bg-light p-1 rounded-circle material-shadow">
                      <Image src={ltc} alt="LTC" width={32} height={32} />
                    </span>
                  </div>
                  <div className="flex-grow-1 ms-2">
              ...
              <li className="list-group-item px-0 pb-0">
                <div className="d-flex">
                  <div className="flex-shrink-0 avatar-xs">
                    <span className="avatar-title bg-light p-1 rounded-circle material-shadow">
                      <Image src={dash} alt="DASH" width={32} height={32} />
                    </span>
                  </div>
                  <div className="flex-grow-1 ms-2">
