...
const CoverSignIn = () => {
  document.title =
    "Cover SignIn | Velzon - Next.js TypeScript Admin & Dashboard Template";

  const [passwordShow, setPasswordShow] = useState<boolean>(false);

  const validation: FormikProps<SignInFormValues> = useFormik<SignInFormValues>(
    {
